...
urlpatterns = [
    ...
    path('add-reaction/<str:eventID>', views.add_reaction_view, name='add_reaction_view'),
    path('get-reactions/<str:eventID>', views.get_reactions_view, name='get_reactions_view'),
